...
public class WineResource {
    private let adapter: WineAdapter
    private let path = "/api/wines"
    private let pathWithID = "/api/wines/:id"

    init(factory: AdapterFactory) throws {
        adapter = try factory.getWineAdapter()
    }
